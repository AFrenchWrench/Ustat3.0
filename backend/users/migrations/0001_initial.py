    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='main.cities')),
                ('province', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='main.provinces')),
