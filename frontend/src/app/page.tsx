        ...
        <div className={style.bottomDiv}>
          ...
          <div className={style.gridDiv}>
            <div className={style.productsGrid}>
              <picture onClick={() => push("/products/S")} className={style.picture1}>
                <span></span>
                <img src="image/Rectangle 31.png" alt="" />
                <p>مبل ها</p>
              </picture>
              <picture onClick={() => push("/products/B")} className={style.picture2}>
                <span></span>
                <img src="image/Rectangle 31.png" alt="" />
                <p>سرویس خواب</p>
              </picture>
              <picture onClick={() => push("/products/M")} className={style.picture3}>
                <span></span>
                <img src="image/Rectangle 31.png" alt="" />
                <p>میز و صندلی</p>
              </picture>
              <picture onClick={() => push("/products/J")} className={style.picture4}>
                <span></span>
                <img src="image/Rectangle 31.png" alt="" />
                <p>جلومبلی و عسلی</p>
              </picture>
              <picture onClick={() => push("/products/C")} className={style.picture5}>
                <span></span>
                <img src="image/Rectangle 31.png" alt="" />
                <p>آینه کنسول</p>
              </picture>
